...
#
# Pocket ID client settings for Seerr.
# Run from the media stack directory (stacks/media).
#
app_name=seerr
client_name="Seerr"
launch_url=$(pulumi stack output --json | jq -er '.endpoints.seerr')
launch_url="${launch_url%/}"
callback_urls=("$launch_url/sso/OID/redirect/pocketid")
logout_callback_urls=()
dark_icon_url=https://cdn.jsdelivr.net/gh/selfhst/icons@main/svg/seerr.svg
light_icon_url=https://cdn.jsdelivr.net/gh/selfhst/icons@main/svg/seerr-light.svg
pkce_enabled=true

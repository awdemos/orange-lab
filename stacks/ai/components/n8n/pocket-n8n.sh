...
#
# Pocket ID client settings for n8n.
# Run from the ai stack directory (stacks/ai).
#
app_name=n8n
client_name="n8n"
launch_url=$(pulumi stack output --json | jq -er '.endpoints.n8n')
launch_url="${launch_url%/}"
callback_urls=("$launch_url/")
logout_callback_urls=()
dark_icon_url=https://cdn.jsdelivr.net/gh/selfhst/icons@main/svg/n8n.svg
light_icon_url=https://cdn.jsdelivr.net/gh/selfhst/icons@main/svg/n8n-light.svg
pkce_enabled=true
